...
Frontend: Clone and run the frontend application from the following repository: https://github.com/elpezpr/PostShare-FrontEnd. Follow the instructions in the frontend repository's README to set up and start the user interface.
